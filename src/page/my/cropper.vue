<template>
    <div>
      ...
      <div>
        <div class="show" style="height:56px;width:56px; border: 1px solid red">
          <div class="picture" :style="'backgroundImage:url('+headerImage+')'" style="height:56px;width:56px;">
          </div>
        </div>
        <div style="opacity:1;width:360px;position:absolute;top:0;right:0;height:56px; border: 1px solid forestgreen">
...
export default {
  props: {
    headerImage: { //从父组件传过来的数据库图片，即用户从本地上传的图片
      type: String,
      default: ''
    }
  },
